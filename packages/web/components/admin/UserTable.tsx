      ...
      <div className="border border-border rounded-xl overflow-hidden">
        ...
        {users.map((user, i) => (
          <motion.div
            ...
            className="grid grid-cols-[2fr_2fr_2fr_1fr_1.5fr_1fr] gap-4 px-4 items-center h-[56px] border-b border-border last:border-b-0 hover:bg-surface-2/60 transition-colors duration-100"
          >
