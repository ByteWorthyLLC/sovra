...
Plans:
- [x] 05-01-PLAN.md - DB migration (workspace_agents, memory_strategy, sequential mode) + workspace types/actions/queries + shared memory
- [x] 05-02-PLAN.md - Socket.IO server in Go worker + broadcast HTTP endpoint + room management
- [x] 05-03-PLAN.md - Memory strategies (conversation, summary, vector, hybrid) + context compression
